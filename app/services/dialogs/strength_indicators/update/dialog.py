...
from app.services.dialogs.states import UpdateStrengthIndicator, ProfileDialog
from app.services.dialogs.strength_indicators.update.getters import get_all_exercises, get_exercise_info, get_data
from app.services.dialogs.strength_indicators.update.handlers import get_select_exercise, get_new_input_strength_indicator, \
