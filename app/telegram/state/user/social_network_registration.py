...
# from app.telegram.keyboards.user.reply import get_social_network_reply_menu
# from app.telegram.state.states import RegSocialNetwork
#
# router = Router()
#
...
#         state: FSMContext,
# ) -> None:
#     """Старт регистрации пользователя."""
